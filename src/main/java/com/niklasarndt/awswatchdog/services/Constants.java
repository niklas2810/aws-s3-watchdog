...
public class Constants {
    ...
    public static final String MAIL_TEXT = "Hey there!<br><br>" +
            "This is an automated message sent by the AWS S3 Watchdog. This message has been sent " +
            "to inform you that the S3 Bucket <b>%s</b> received <i>%d</i> new objects.<br><br>" +
